...
static unsigned char symtestkey9[] =
{
...
static unsigned char symtestinput9[] =
{
    ...
    if ((key_info == NULL) || (sym_ctx == NULL) || (inputText == NULL)
        ...
        if ((code == test->result) && (code == FSL_RETURN_OK_S)) {
            ...
            if (code == test->result) {
                ...
                passed = 0;
                printf("fsl_shw_symmetric_%s() returned \"%s\" instead of "
                   ...
                   uint32_t* total_failed_count)
{
    ...
    printf("symmetric: %d tests passed, %d tests failed, %d tests skipped\n\n",
